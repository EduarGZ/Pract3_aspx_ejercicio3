<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Escribir.aspx.cs" Inherits="Ejercicio3.Escribir" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Table runat="server">
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Button runat="server" ID="btn_Confir" OnClick="btn_Confir_Click1" Text="Confirm" />
                    </asp:TableCell>
                    <asp:TableCell>
                    </asp:TableCell>
                </asp:TableRow>
